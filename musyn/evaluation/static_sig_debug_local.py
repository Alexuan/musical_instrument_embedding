...
def generate_data(data_struct, mode='eer'):
    ...
    """
    # __import__('ipdb').set_trace()
    sta_sig_ma = np.load('sta_sig_eer_tab3_rwc.npy')
    system_list = ['rwc_fil_sinc_midi_asm_s100_pretrained_w_trans', 'rwc_fil_sinc_midi_asm_s1000_pretrained_w_trans', 'rwc_fil_sinc_midi_asm_s10000_pretrained_w_trans', 'rwc_fil_sinc_midi_asm_s100_pretrained', 'rwc_fil_sinc_midi_asm_s1000_pretrained', 'rwc_fil_sinc_midi_asm_s10000_pretrained', 'rwc_fil_sinc_midi_aug_asm_s100_instr_pretrained', 'rwc_fil_sinc_midi_aug_asm_s1000_instr_pretrained', 'rwc_fil_sinc_midi_aug_asm_s10000_instr_pretrained', 'rwc_fil_sinc_midi_aug_s100_pretrained', 'rwc_fil_sinc_midi_aug_s1000_pretrained', 'rwc_fil_sinc_midi_aug_s10000_pretrained']
    print('system list:{}, len:{}'.format(system_list, len(system_list)))
    return system_list, sta_sig_ma


def plot_mat(ax, matrix, labels):
    ax.spy(matrix, markersize=27)
...
def main():
    ...
    data_struct = data_struct_tab2_rwc
    fig = plt.figure()
    ...
    fig.tight_layout()
    fig.savefig('statistical_significance_test_eer_tab3_rwc.pdf')
