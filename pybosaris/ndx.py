...
class Ndx:
    ...
    def __eq__(self, other):
        ...
        assert(isinstance(other,Ndx))
        assert(other.validate())

        ok = self.trialmask.shape == other.trialmask.shape
        if not ok:
            return False
        ...
        ok &= (self.trialmask[sort_idx0_model,:][:,sort_idx0_segs] == other.trialmask[sort_idx1_model,:][:,sort_idx1_segs]).all()
